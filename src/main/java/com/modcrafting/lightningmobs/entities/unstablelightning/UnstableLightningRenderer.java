...
@OnlyIn(Dist.CLIENT)
public class UnstableLightningRenderer extends EntityRenderer<UnstableLightning> {
	
   public UnstableLightningRenderer(EntityRendererProvider.Context context) {
      super(context);
   }

   /*
    * Code taken from LightningBoltRender
    */
   public void render(UnstableLightning pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
   ...
   @Override
   public ResourceLocation getTextureLocation(UnstableLightning entity) {
